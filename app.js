...
app.post('/api/v1/endpoint', (request, response) => {
    ...
    if ("view" in requestJson) {
        ...
        else if (requestJson.actions[0].action_id == "is_notify_at_channel" || requestJson.actions[0].action_id == "is_anonymous" || requestJson.actions[0].action_id == "is_notify_to_user" || requestJson.actions[0].action_id == 'is_multiple_selection') {
